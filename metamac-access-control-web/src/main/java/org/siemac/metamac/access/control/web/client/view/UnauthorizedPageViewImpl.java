...
import org.siemac.metamac.access.control.web.client.view.handlers.UnauthorizedPageUiHandlers;
...
public class UnauthorizedPageViewImpl extends ViewWithUiHandlers<UnauthorizedPageUiHandlers> implements UnauthorizedPagePresenter.UnauthorizedPageView {
    ...
    public UnauthorizedPageViewImpl() {
        ...
        contents.append("<hr>").append(MetamacWebCommon.getMessages().applicationAccessDenied(AccessControlWeb.getCurrentUser().getUserId())).append("<hr>");
