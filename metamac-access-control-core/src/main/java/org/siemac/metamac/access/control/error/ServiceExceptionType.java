...
public class ServiceExceptionType extends CommonServiceExceptionType {
    ...
    public static final CommonServiceExceptionType ROLE_NOT_OK                          = create("exception.acl.role.not_ok");
    ...
    public static final CommonServiceExceptionType APP_NOT_OK                           = create("exception.acl.app.not_ok");
    ...
    public static final CommonServiceExceptionType USER_NOT_OK                          = create("exception.acl.user.not_ok");
    ...
    public static final CommonServiceExceptionType ACCESS_NOT_OK                        = create("exception.acl.access.not_ok");
