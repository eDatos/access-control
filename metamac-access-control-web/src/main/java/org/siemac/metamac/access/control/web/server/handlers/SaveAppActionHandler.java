...
@Component
public class SaveAppActionHandler extends SecurityActionHandler<SaveAppAction, SaveAppResult> {
    ...
    @Override
    public SaveAppResult executeSecurityAction(SaveAppAction action) throws ActionException {
