package org.siemac.metamac.access.control.web.server.servlet;
...
public class FileDownloadServlet extends FileDownloadServletBase {
    ...
    private AccessControlConfigurationService getConfigurationService() {
        if (configurationService == null) {
            configurationService = ApplicationContextProvider.getApplicationContext().getBean(AccessControlConfigurationService.class);
        }
