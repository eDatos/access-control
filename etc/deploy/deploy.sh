...
scp -o ProxyCommand="ssh -W %h:%p deploy@estadisticas.arte-consultores.com" metamac-access-control-web/target/access-control-internal-*.war deploy@estadisticas.arte.internal:$TRANSFER_PATH/access-control-internal.war
