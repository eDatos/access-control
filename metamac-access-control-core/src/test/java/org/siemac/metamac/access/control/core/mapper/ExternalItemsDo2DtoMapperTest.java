...
import org.siemac.metamac.access.control.service.mapper.Do2DtoMapperImpl;
...
public class ExternalItemsDo2DtoMapperTest {
    ...
    public void testExternalItemDoToDtoWithExistsParameter() throws Exception {
        testExternalItemDoToDto(AccessControlDoMocks.mockAgencyExternalItem());
    }
    ...
    private void testExternalItemDoToDto(ExternalItem externalItem) throws Exception {
        ...
        AccessControlBaseAsserts.assertEqualsExternalItem(externalItem, result, MapperEnum.DO2DTO);
    }
}
