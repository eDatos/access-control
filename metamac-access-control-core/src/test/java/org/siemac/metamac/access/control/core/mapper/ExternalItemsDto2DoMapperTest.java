package org.siemac.metamac.access.control.core.mapper;
...
import org.siemac.metamac.access.control.core.serviceapi.utils.AccessControlBaseAsserts;
...
import org.siemac.metamac.access.control.service.mapper.Dto2DoMapperImpl;
...
public class ExternalItemsDto2DoMapperTest {
    ...
    public void testExternalItemDtoToEntityExistsDtoAndNullDo() throws Exception {
        // EXISTS, NULL
        ExternalItemDto externalItemDto = AccessControlDtoMocks.mockExternalItemDtoComplete(CODE_01, URN_01, TypeExternalArtefactsEnum.AGENCY);
    ...
    public void testExternalItemDtoToEntityNullDtoAndExistsDo() throws Exception {
        // NULL, EXISTS
        ExternalItem externalItem = AccessControlDoMocks.mockAgencyExternalItem();
    ...
    private void testExternalItemDtoToEntity(ExternalItemDto externalItemDto, ExternalItem externalItem) throws Exception {
        ...
        AccessControlBaseAsserts.assertEqualsExternalItem(result, externalItemDto, MapperEnum.DTO2DO);
    }
}
