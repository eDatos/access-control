...
public class ServiceExceptionType extends CommonServiceExceptionType {
    ...
    public static final CommonServiceExceptionType ACCESS_ALREADY_EXIST_WITH_OPERATION    = create("exception.acl.access.already_exists.with_operation");
    public static final CommonServiceExceptionType ACCESS_ALREADY_EXIST_WITHOUT_OPERATION = create("exception.acl.access.already_exists.without_operation");
